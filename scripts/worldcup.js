...
(function () {
  ...
  const HUB_LINKS = {
    ...
    BritainWTF: 'regional/pages/britain-directory.html',
    EnglandWTF: 'regional/pages/britain-directory.html',
    WalesWTF: 'regional/pages/britain-directory.html',
    NorthernIrelandWTF: 'regional/pages/britain-directory.html',
    WatchTheFallWTF: 'index.html',
    EuropeWTF: 'regional/pages/europe-directory.html',
    TheWestWTF: 'regional/pages/thewest-directory.html',
    TheWest: 'regional/pages/thewest-directory.html',
    AustraliaWTF: 'regional/pages/thewest-directory.html',
    CanadaWTF: 'regional/pages/thewest-directory.html',
    IrelandWTF: 'regional/pages/europe-directory.html',
    FranceWTF: 'regional/pages/europe-directory.html',
    GermanyWTF: 'regional/pages/europe-directory.html',
    PolandWTF: 'regional/pages/europe-directory.html',
    NetherlandsWTF: 'regional/pages/europe-directory.html',
    ItalyWTF: 'regional/pages/europe-directory.html',
    SwedenWTF: 'regional/pages/europe-directory.html',
    AIWTF: 'regional/pages/ai-directory.html',
    AITechWTF: 'regional/pages/ai-directory.html',
    GadgetsWTF: 'regional/pages/global-directory.html',
    ComedyWTF: 'regional/pages/global-directory.html',
    DarkHumourWTF: 'regional/pages/global-directory.html',
    ConceptsWTF: 'regional/pages/global-directory.html'
  };
