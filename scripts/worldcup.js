...
(function () {
  ...
  const HUB_LINKS = {
    ...
    AIWTF: 'ai.html',
    AITechWTF: 'ai.html',
    // All other hubs route to homepage directory
    BritainWTF: 'index.html#directory',
    EnglandWTF: 'index.html#directory',
    WalesWTF: 'index.html#directory',
    NorthernIrelandWTF: 'index.html#directory',
    EuropeWTF: 'index.html#directory',
    TheWestWTF: 'index.html#directory',
    TheWest: 'index.html#directory',
    AustraliaWTF: 'index.html#directory',
    CanadaWTF: 'index.html#directory',
